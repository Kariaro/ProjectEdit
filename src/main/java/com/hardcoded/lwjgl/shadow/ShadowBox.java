...
//import com.hardcoded.lwjgl.LwjglConstants;
...
//		toNear.mul(LwjglRender.NEAR_PLANE);
//		
...
//		farWidth = (float)(SHADOW_DISTANCE * Math.tan(Math.toRadians(LwjglConstants.getFov())));
//		nearWidth = (float)(LwjglRender.NEAR_PLANE * Math.tan(Math.toRadians(LwjglRender.getFov())));
...
//		return (float)(LwjglRender.width) / ((float)LwjglRender.height);
//	}
//	
//	
