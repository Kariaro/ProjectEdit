...
public class Texture {
	...
	public static final void unloadTextureCache() {
		for(String key : cacheTextureId.keySet()) {
			cacheTextureId.get(key).cleanup();
		}
		cacheTextureId.clear();
		
		for(String key : cache.keySet()) {
			cache.get(key).cleanup();
		}
		cache.clear();
	}
